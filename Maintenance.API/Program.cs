...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Fleet Maintenance - Maintenance API",
        Version = "v1",
        Description = "Maintenance Operations microservice for Fleet Maintenance System (Faults, Job Cards, Service Schedules)"
    });
